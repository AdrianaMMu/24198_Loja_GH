...
?>
    ...
    <head>
        ...
        <style>
  body.bg-light {
    background-color: #f9f7f1 !important; /* tom clarinho */
  ...
  /* Navbar */
  .navbar.bg-primary {
    background-color: #5a4e42 !important; /* marrom escuro */
  }
  .navbar-brand {
    font-weight: 700;
    font-size: 1.4rem;
  ...
  .card-header.bg-primary {
    background-color: #7f6a53 !important; /* marrom médio */
    color: #fff;
  }
  .card {
  ...
  .modal-header.bg-warning {
    background-color: #b9986f !important;
    color: #fff;
  }
  .modal-header.bg-success {
    background-color: #a07e58 !important;
    color: #fff;
  }
  ...
  .form-control {
    border-radius: 5px;
    border: 1px solid #bda07e;
  }
  .form-control:focus {
    border-color: #a07e58;
    box-shadow: 0 0 5px rgba(160, 126, 88, 0.5);
  }
  ...
  <div class="d-flex justify-content-end">
    <a href="../index.php" class="btn btn-link text-muted p-0 small" style="text-decoration: none;">
